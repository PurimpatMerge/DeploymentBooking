            ...
            <div className="lg:flex justify-center p-5   lg:h-[100px] w-fit left-1/2 -translate-x-1/2 bottom-[-120px]  absolute  shadow-2xl  sm:bottom-[-120px] lg:bottom-[-50px] lg:justify-between rounded-md bg-[#9f9dc7] border border-black lg:p-1">
              ...
              <div className="flex  ">
                <div className="relative h-10 w-[300px] mt-2    lg:my-auto lg:ml-5">
                  <div className="absolute top-2/4 right-3 grid h-5 w-5 -translate-y-2/4 place-items-center text-blue-gray-500">
                    <FontAwesomeIcon
                      icon={faPerson}
                      className="my-auto mx-2 text-xl text-[#000000]"
                    />
                  </div>
                  <input
                    type="number"
              ...
              <div className="flex my-2 justify-center">
                <button
                  ...
                  className="inline-block px-6 py-2.5 bg-white text-gray-700 font-medium text-xs leading-tight uppercase rounded-md shadow-md hover:bg-[#6C0BA9] hover:text-white   duration-150 "
                >
                  Search
                </button>
              </div>
